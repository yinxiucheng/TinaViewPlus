...
//    }
    ...
    public static String getDeviceId() {
        if (deviceId == null) {
            ...
            @SuppressLint("HardwareIds") String androidId = Settings.Secure.getString(Utils.getApplicationContext().getContentResolver(), Settings.Secure.ANDROID_ID);
    ...
    public static String getIMEIValue() {
        ...
        try {
            TelephonyManager telephonyManager = (TelephonyManager) Utils.getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
